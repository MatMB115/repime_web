...
class TestRegistersenhainvalida():
  ...
  def test_registersenhainvalida(self):
    ...
    self.driver.find_element(By.ID, "email").send_keys("joaomarcos2803@hotmail.com")
    self.driver.find_element(By.ID, "nome").send_keys("João Marcos")
